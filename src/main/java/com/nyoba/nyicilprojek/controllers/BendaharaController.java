...
import com.nyoba.nyicilprojek.repository.chamberlain.ChamberlainRepository;
import com.nyoba.nyicilprojek.repository.chamberlain.PUBBalanceRepository;
...
public class BendaharaController extends AuthConfig {
    ...
    public String save(Chamberlain chamberlain){
        ...
        PUBBalance balancePrimary=pubBalanceRepository.getReferenceById(lastId);
